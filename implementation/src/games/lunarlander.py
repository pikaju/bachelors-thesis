...
class MuZeroConfig:
    def __init__(self):
        ...
        self.fc_reconstruction_layers = [64]  # Define the hidden layers in the reconstruction network
        ...
        self.training_steps = 35000  # Total number of training steps (ie weights update according to a batch)
