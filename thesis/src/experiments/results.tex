...
An agent using both loss terms simultaneously outperforms MuZero (as can be seen in figure \ref{fig:hybrid_results}), and even scores marginally better than the reconstruction loss agent, in all environments tested.